...
var _user$project$Main$drawPin = F2(
	function (index, pin) {
		var color = function () {
			var _p0 = pin.mode;
			if (_p0.ctor === 'PinInput') {
				return 'green';
			} else {
				return pin.state ? 'red' : 'black';
			}
		}();
		return A2(
			_elm_lang$svg$Svg$g,
				...
				_0: A2(
					_elm_lang$svg$Svg$rect,
					{
						...
						_0: _elm_lang$svg$Svg_Attributes$x(
							_elm_lang$core$Basics$toString(index * 20)),
						_1: {
							ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: _elm_lang$svg$Svg$text(
								_elm_lang$core$Basics$toString(pin.gpio)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$viewPin = function (pin) {
	return A2(
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(pin.mode)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(pin.state)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$bool01Decoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (integer) {
		var _p1 = integer;
		switch (_p1) {
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {input: a, messages: b, pins: c};
	});
...
var _user$project$Main$Pin = F3(
	function (a, b, c) {
		return {gpio: a, state: b, mode: c};
	});
var _user$project$Main$PinOutput = {ctor: 'PinOutput'};
var _user$project$Main$PinInput = {ctor: 'PinInput'};
var _user$project$Main$pinModeDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (pinMode) {
		var _p2 = pinMode;
		switch (_p2) {
			case 'input':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Main$PinInput);
			case 'output':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Main$PinOutput);
			default:
				return _elm_lang$core$Json_Decode$fail(_p2);
		}
	},
	_elm_lang$core$Json_Decode$string);
var _user$project$Main$pinDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Main$Pin,
	A2(_elm_lang$core$Json_Decode$field, 'pin', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'pin_state', _user$project$Main$bool01Decoder),
	A2(_elm_lang$core$Json_Decode$field, 'direction', _user$project$Main$pinModeDecoder));
var _user$project$Main$decodeMessage = function (message) {
	var _p3 = A2(
		...
		A2(
			...
			'gpios',
			_elm_lang$core$Json_Decode$list(_user$project$Main$pinDecoder)),
		message);
	if (_p3.ctor === 'Ok') {
		return _p3._0;
	} else {
		...
		switch (_p4.ctor) {
			...
			case 'Send':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$websocket$WebSocket$send, 'ws://echo.websocket.org', '')
				};
			case 'NewMessage':
				return {
					ctor: '_Tuple2',
					_0: A3(
						...
						model.input,
						model.messages,
						_user$project$Main$decodeMessage(_p4._0)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SendRising':
				return {
							...
							_elm_lang$core$Json_Encode$object(
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'pin',
										_1: _elm_lang$core$Json_Encode$int(_p4._0.gpio)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'interrupt_direction',
											_1: _elm_lang$core$Json_Encode$string('rising')
										},
										_1: {ctor: '[]'}
									}
								})))
							...
							_elm_lang$core$Json_Encode$object(
								{
									...
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'interrupt_direction',
											_1: _elm_lang$core$Json_Encode$string('falling')
										},
										_1: {ctor: '[]'}
									}
								})))
...
var _user$project$Main$SendFalling = function (a) {
	return {ctor: 'SendFalling', _0: a};
};
var _user$project$Main$SendRising = function (a) {
	return {ctor: 'SendRising', _0: a};
};
var _user$project$Main$viewInputPinButtons = function (pin) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$SendRising(pin)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$SendFalling(pin)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$svg$Svg$svg,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$height('55'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 200 55'),
							_1: {
								ctor: '::',
				...
				A2(_elm_lang$core$List$indexedMap, _user$project$Main$drawPin, model.pins)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$viewInputPinButtons,
						A2(
							_elm_lang$core$List$filter,
							function (pin) {
								return _elm_lang$core$Native_Utils.eq(pin.mode, _user$project$Main$PinInput);
							},
							model.pins))),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:8080/ws', _user$project$Main$NewMessage);
};
